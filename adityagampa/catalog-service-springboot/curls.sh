...
curl -X GET "http://localhost:8088/api/v1/catalog/brands?pageSize=2&pageIndex=1" -H "accept: */*" -H "Content-Type: application/json" 

echo -e "\n---- GET: /api/v1/catalog/types ----"

curl -X GET "http://localhost:8088/api/v1/catalog/types?pageSize=2&pageIndex=1" -H "accept: */*" -H "Content-Type: application/json"

echo -e "\n---- GET: /api/v1/catalog/items ----"

curl -X GET "http://localhost:8088/api/v1/catalog/items?pageSize=2&pageIndex=1" -H "accept: */*" -H "Content-Type: application/json"

echo -e "\n---- GET: /api/v1/catalog/items/id ----"

curl -X GET "http://localhost:8088/api/v1/catalog/items/1" -H "accept: */*" -H "Content-Type: application/json"
